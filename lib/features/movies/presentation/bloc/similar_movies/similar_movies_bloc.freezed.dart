...
extension SimilarMoviesStatePatterns on SimilarMoviesState {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SimilarMoviesState value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _SimilarMoviesState() when $default != null:
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(MoviesStateStatus status, List<MovieItemEntity> movies)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
