...
/// Adds pattern-matching-related methods to [KhoPhimMoviesState].
extension KhoPhimMoviesStatePatterns on KhoPhimMoviesState {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_KhoPhimMoviesState value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _KhoPhimMoviesState() when $default != null:
